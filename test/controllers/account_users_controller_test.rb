...
class AccountUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_user" do
    assert_difference("AccountUser.count") do
      post account_users_url, params: { account_user: { account_id: @account_user.account_id, user_id: @unassigned_user.id, user_role: @account_user.user_role } }
    end
  ...
  test "should update account_user" do
    patch account_user_url(@account_user), params: { account_user: { account_id: @account_user.account_id, user_id: @account_user.user_id, user_role: @account_user.user_role } }
