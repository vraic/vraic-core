class AccountUsersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @account_user.update(account_user_params)
        format.html { redirect_to @account_user, notice: "Account user was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to account_users_path, notice: "Account user was successfully destroyed.", status: :see_other }
